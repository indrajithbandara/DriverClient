 ...
 */
public class GetConsumeResponse {

    public static void getConsumeResponse(final Activity mContext, Integer accountId, Integer pageNo, Integer pageSize) {
        ...
        client.post(url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                if(res != null) {
                    LoginActivity.getInstance().doWithConsumeRecordsResult(obj.get("msg").getAsString(), res, true);
                    SharedPreferences sp = mContext.getSharedPreferences("consume",MODE_PRIVATE);
                    ...
                    LoginActivity.getInstance().doWithConsumeRecordsResult(obj.get("msg").getAsString(), res, false);
                }
            }
