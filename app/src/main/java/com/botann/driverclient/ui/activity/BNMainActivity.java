...
import com.botann.driverclient.ui.handler.BNEventHandler;
...
//        }).start();
    ...
    private void routeplanToNavi(CoordinateType coType) {
        ...
        switch (coType) {
            case GCJ02: {
                sNode = new BNRoutePlanNode(bundle.getDouble("sLongitude"), bundle.getDouble("sLatitude"), bundle.getString("sName"), null, coType);
                eNode = new BNRoutePlanNode(bundle.getDouble("eLongitude"), bundle.getDouble("eLatitude"), bundle.getString("eStationName"), null, coType);
                break;
            }
            case WGS84: {
                sNode = new BNRoutePlanNode(bundle.getDouble("sLongitude"), bundle.getDouble("sLatitude"), bundle.getString("sName"), null, coType);
    ...
    private void initSetting() {
        ...
        Bundle bundle = new Bundle();
        // 必须设置APPID，否则会静音
        bundle.putString(BNCommonSettingParam.TTS_APP_ID, "9925003");
