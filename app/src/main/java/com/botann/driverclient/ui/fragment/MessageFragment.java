...
public class MessageFragment extends Fragment {
    ...
    public static MessageFragment newInstance(String messageInfoList, Integer total) {
                    ...
                    public void run() {
                        ...
                        client.post(url, params, new AsyncHttpResponseHandler() {
                            ...
                            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                                ...
                                MessageFragment MF = new MessageFragment().newInstance(res,total);
                                transaction.replace(R.id.message_fragment_container,MF);
                                transaction.commit();
                                if(res != null) {
